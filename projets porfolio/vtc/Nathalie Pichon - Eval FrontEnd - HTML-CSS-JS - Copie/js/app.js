...
(function($){
	...
	*************************/
	...
	// On retrouve ici toutes les fonctions
	// responsables des animations

	// Ici, on a déclaré une première méthode dans notre objet app
	...
	$document.ready(function(){
		// la méthode () ne sera éxécutée que quand la page
		// sera entièrrement chargée
		app.();
